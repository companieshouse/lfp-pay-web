...
public class UserModel implements IUserModel {
    ...
    private String yesNoRadioButtons;
    ...
    public String getYesNoRadioButtons() {
        return yesNoRadioButtons;
    }

    public void setYesNoRadioButtons(String yesNoRadioButtons) {
        this.yesNoRadioButtons = yesNoRadioButtons;
    }
